...
const std::vector<std::shared_ptr<Item>> items = {
    ...
    std::make_shared<MapPiece>(2),
    std::make_shared<Map>("Карта архипелага", "Открывает карту архипелага", 500),
    std::make_shared<HealingItem>("Доски", "", 55, 150, 1),
    std::make_shared<HealingItem>("Стальные листы", "", 120, 250, 1),
    ...
    std::make_shared<BuckshotItem>("Картечь", "С шансом 50 % поражает личный состав вражеского корабля. Сила снаряжения противника уменьшается", 500, 1),
    std::make_shared<ShipCannons>("Бомбарды", "", 20, 30, 1, 250),
    std::make_shared<ShipCannons>("12-фунтовые пушки", "", 60, 50, 2, 400),
    std::make_shared<ShipCannons>("24-фунтовые пушки", "", 80, 75, 3, 850),
    std::make_shared<ShipBoardingTeam>("Корабельные крысы", "", 20, 50),            // 10
    std::make_shared<ShipBoardingTeam>("Бывалые каперы", "", 40, 150),
    std::make_shared<ShipBoardingTeam>("Морские волки", "", 80, 750),
    std::make_shared<ShipHull>("Деревянный корпус", "", 120, 25, 0, 0, 1, 0, 2500),
    std::make_shared<ShipHull>("Полу-бронированный корпус", "", 150, 35, 53, 28, 2, 50, 1000),
    std::make_shared<ShipHull>("Бронированный корпус", "", 170, 75, 60, 57, 3, 75, 2500),       // 15
    std::make_shared<ShipSail>("2 мачты, обычные паруса", "", 41, 35, 50),
    std::make_shared<ShipSail>("2 мачты, отличные паруса", "", 55, 50, 200),
    std::make_shared<ShipSail>("3 мачты, обычные паруса", "", 75, 70, 1000)   // 18
};
